...
DO $$
    ...
    BEGIN
        ...
        CREATE TABLE public.cartoes_de_credito (
            ...
            CONSTRAINT cartoesdecredito_bandeirascartao_fk FOREIGN KEY (bnd_id) REFERENCES bandeiras_cartao (bnd_id)
        );
        ...
        INSERT INTO livros (lvr_autor, lvr_preco_de_custo, lvr_ano, lvr_titulo, lvr_editora, lvr_edicao, lvr_isbn, lvr_numero_paginas, lvr_sinopse, lvr_altura, lvr_largura, lvr_profundidade, lvr_cod_barras, grupo_precificacao_grp_id)
